-- Sjednocení sémantiky idempotentního opakování: poznámka je součástí rezervačního payloadu.
-- Funkce zachovává původní signaturu, návratový typ i oprávnění, takže migrace je zpětně kompatibilní.
