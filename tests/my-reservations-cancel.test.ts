...
test('isMyReservationUpcoming: budoucí aktivní rezervace jsou aktuální, zrušené patří do historie', async () => {
  ...
  assert.equal(isMyReservationUpcoming({ reservationDate: '2026-01-10', timeFrom: '10:00:00', status: 'waiting_for_payment' }, now), true);
