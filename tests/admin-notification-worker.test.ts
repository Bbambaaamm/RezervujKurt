...
test('approved e-mail pro ručně schváleného nečlena obsahuje instrukce k zámku', () => {
  ...
  assert.match(message.text, /zamčený hlavní vchod/);
  assert.match(message.text, /zadní vchod/);
  assert.match(message.text, /2275/);
  assert.match(message.text, /\/images\/zadni-vchod-mapa\.svg/);
  assert.match(message.text, /250 Kč/);
  assert.match(message.text, /QR kód na nástěnce/);
  assert.match(message.html, /zamčený hlavní vchod/);
  assert.match(message.html, /zadní vchod/);
  assert.match(message.html, /2275/);
  assert.match(message.html, /<img src="https:\/\/rezervuj-kurt\.vercel\.app\/images\/zadni-vchod-mapa\.svg"/);
...
test('approved e-mail pro člena neobsahuje instrukce k zadnímu vchodu', () => {
  ...
  assert.ok(message);
  assert.doesNotMatch(message.text, /zamčený hlavní vchod/);
  ...
  assert.doesNotMatch(message.html, /zamčený hlavní vchod/);
